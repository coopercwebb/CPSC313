 ...
 * The only fields we use for this assignment are i_size, i_direct and i_2indirect.
 * The inode contains 8 disk addresses for Direct blocks and
 * one disk address for a Double-Indirect block.
...
typedef struct CS313inode {
  ...
  uint64_t i_direct[8]; // Direct blocks
