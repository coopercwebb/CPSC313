...
typedef struct simcache_s {
  ...
  /* Age of the cache for LFU with dynamic aging. */
  uint32_t age;
...
/*
 * Create a new cache that contains a total of num_bytes lines, each of which is
 * block_size bytes long, with the given associativity and policies.
 */
